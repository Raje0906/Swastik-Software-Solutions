export default function WhatsAppButton() {
    const number = '91XXXXXXXXXX' // Replace with actual WhatsApp business number
    const message = encodeURIComponent('Hi Swastik! I\'d like to know more about your training programs.')
